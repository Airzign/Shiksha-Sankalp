...
<h2 class="innersubheading"><b>How can volunteers participate in the program? </b></h2><br />


<!-- The content for Volunteer Responsibilities -->

<p class="innertext">Volunteers are an important pillar of the Learning Rewards Model. We leverage volunteer support in activities conducted directly by Shiksha Sankalp as well as those conducted by our partner NGOs, as explained below:</p>

<h3 class="innersubheading"><u>SS Executed Activities:</u></h3>
    <ul>
        ...
        <p class="innertext">(These activities can be conducted remotely through internet. Volunteers are provided with password based access to the internet based Pardarshee (Transparency) system for these activities.)</p>
...
<p class="innertext">All partner NGO activities listed below are expected to be done in the target area itself. Volunteers living in the vicinity would be better suited for these tasks.</p>
...
<ul>
    ...
    <p class="innertext">Volunteers conduct a door-to-door survey of households in the proposed target area. Survey of schools, banks and other NGOs in the area are also carried out. Volunteers take photographs of the proposed target area, including households, by-lanes, public toilets, dispensaries/medical centers, playgrounds, places of worship etc. Volunteers also take photos of schools, banks and other NGOs covered in the survey. </p>

    <li class="answer">Communications Campaign</li>
    <p class="innertext">Volunteers conduct a communications campaign in the target area explaining the Learning Rewards Model to the people through posters, banners, audio communication and door-to-door interfacing. </p>

    <li class="answer">Beneficiary Registration</li>
    <p class="innertext">Volunteers conduct a drive in the target area to register beneficiaries. The drive involves explaining the Learning Rewards model, getting registration forms filled up, obtaining documentary evidence for eligibility and taking photographs of the beneficiaries. All this information is uploaded to the SS MIS system. </p>

    <li class="answer">Regular Interaction with Beneficiaries</li>
    <p class="innertext">Volunteers living in the vicinity of the target area maintain regular contact with the beneficiaries to guide them on their efforts to obtain education and to facilitate the processing of various steps under the Learning Rewards model. Volunteers assist in registration of beneficiaries, information about SAP test, communication of SAP tests results, regular feedback on performance, collecting evidence of attendance/performance at school and disbursement of Learning Rewards stipend cheques. Volunteers follow-up with drop-out families and guide them on how their concerns can be addressed. Volunteers also keep track of various initiatives being taken by beneficiary families to improve the education of their children. </p>
    
    <li class="answer">Arrangements for SAP Test and Invigilation</li>
    <p class="innertext">Volunteers make arrangements for conducting the SAP Test, including the test venue, facilities at the venue, providing test information to the beneficiaries and invigilation of the test. </p>

    <li class="answer">Opening Bank Accounts </li>
    <p class="innertext">Volunteers assist beneficiaries in opening Bank Accounts for mothers. The Bank accounts can also be opened for the students with mothers as guardians. Joint accounts with fathers are not permissible. Volunteers explain the banking processes and good banking practices to the mothers. </p>
