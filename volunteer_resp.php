...
<div id="content">
  <div id="main_content">
	  ...
	  <h3 class="innersubheading">
		<u>SS Executed Activities:</u>
	  </h3>
      <ul>
		<h5 class="innersubheading">A. Field Activities</h5>
		<li class="answer">
		  <strong>Target Area Verification</strong>
		  Volunteers visit the target area proposed by the applicant NGO and independently verify the information submitted
		  as a part of the application. Volunteers also conduct a small sample survey to confirm the broader survey conducted
		  by the applicant NGO. A report is prepared and submitted to SS Selection Committee.
		</li>
		<li class="answer">
		  <strong>SAP Test</strong>
		  Volunteers oversee the administration and invigilation of SAP tests, verify attendance, check answer-sheets, take photographs,
		  and scan and upload all records (including attendance, scores, answer sheets and photographs) into the SS MIS system.
		</li>
		<li class="answer">
		  <strong>Target Area Visits</strong>
		  Volunteers visit the target areas to review the implementation of the Learning Rewards model and obtain feedback from beneficiaries,
		  schools, community leaders and partner NGOs. Volunteers submit a report to SS on their observations, flagging concerns if any.
		</li>
		...
		<li class="answer">
		  <strong>Beneficiary Verification</strong>
		  Volunteers login into the SS MIS system and verify the beneficiary information vis-à-vis the documentary evidence
		  and photographs. This activity can be done by the volunteers from their homes as well.
		</li>
		<li class="answer">
		  <strong>Pre-Award Verification</strong>
		  Prior to award of monthly stipends, volunteers login into the SS MIS system and verify information for each beneficiary,
		  including personal particulars, eligibility conditions, test performance, incentive amount calculation and mother’s bank account.
		</li>
		<li class="answer">
		  <strong>Communication Materials</strong>
		  Volunteers prepare the quarterly newsletter by writing articles based on inputs and latest updates collated from SS headquarters
		  and Partner NGOs in the field.
		</li>
		<li class="answer">
		  <strong>Quarterly Newsletter</strong>
		  Volunteers prepare the quarterly newsletter by writing articles based on inputs and latest updates collated from SS headquarters
		  and Partner NGOs in the field.</li>
		<li class="answer">
		  <strong>Website Information Updates</strong> Volunteers regularly update the information content on the Shiksha Sankalp website
		  and coordinate with the service provider responsible for maintaining the website.</li>
		<h5 class="innersubheading">C. Marketing Activities </h5>
		<li class="answer">
		  <strong> Marketing </strong>
		  to Corporations Volunteers contact corporations, explain the Learning Rewards model / the Million Minds project, make presentations
		</li>
		<li class="answer">
		  <strong> Marketing to</strong>
		  Other NGOs and Social Organizations</li>
		<li class="answer">Preparation of Proposals and Marketing Materials</li>
      </ul>
	  <h3 class="innersubheading"><u>How can NGOs Associate</u></h3>
	  <p class="innertext">
	  ...
	  <ul>
		...
		<p class="innertext">
		  Volunteers conduct a communications campaign in the target area explaining the Learning Rewards Model to
		  the people through posters, banners, audio communication and door-to-door interfacing.
		</p>
		...
		<p class="innertext">
		  ...
		  providing test information to the beneficiaries and invigilation of the test.
		</p>

		<li class="answer">Opening Bank Accounts </li>
		<p class="innertext">
		  Volunteers assist beneficiaries in opening Bank Accounts for mothers. The Bank accounts can also be opened for
		  the students with mothers as guardians. Joint accounts with fathers are not permissible. Volunteers explain the
