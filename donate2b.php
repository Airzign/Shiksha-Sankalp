...
<div id="content">
  <div id="main_content">
    ...
    <p>
      Shiksha Sankalp requires a donation of USD 132 per child per annum (at the
      rate of USD 11 per child per month). Please decide the number of children
  ...
  <script type="text/javascript">
    ...
    function changed()
    {
      ...
      if(isNum(studs) && isNum(years))
        $("#total").html("USD. " + parseInt(studs)*parseInt(years)*132);
      else
        $("#total").html("");
    }
