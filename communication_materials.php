...
<div id="content">
  <div id="main_content">
    ...
    <div class="innertitle">Communication Materials</div>
    <table class="info_table" cellspacing="5px">
      <tr>
        <th style="width:100px;">Date</th>
        <th style="width:440px;">Communication Material</th>
        <th style="width:100px;">File Link</th>
      </tr>
      <?php
	 $results = mysql_query("select * from communication_materials order by date desc");
