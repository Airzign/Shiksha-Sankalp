  ...
  <div id="main_content">
    <p> 
	  ...
	  <div class="innertext">
		...
		Prospective Partner NGOs submit Funding Proposals using format provided by SS. Funding proposals include
		information from the target area survey, NGO’s financial statements, past projects etc. Proposals are to
		be submitted by the set deadline.
		<br /><br />
		3
		Selection of Target Area and Partner NGOs
		SS field staff/volunteers verify target areas. SS Selection Committee reviews and selects Target Area and
		Partner NGO, based on criteria specified in the SS grant rules.
		<br /><br />
		4
		Communication of Learning Rewards Model
		Partner NGO staff explains Learning Rewards Model in the Target Area using materials provided by SS.
		Banners, posters, door-to-door campaigns and audio announcements are used.
		<br /><br />
		5
		...
		Partner NGO staff informs all students about the results and incentive amount, and provide copies of
		their marked answer-sheets. Results are also put up on wall-posters throughout the target area in
		descending order of incentive amount.
		<br /><br />
		9
		Opening Bank Accounts
		Partner NGO staff assist beneficiaries in opening mothers’ Bank Accounts. Joint account with father is not
		acceptable. Student account with mother as guardian is fine. Onus of opening the Bank account is on the
		families and not on the Partner NGO.
		<br /><br />
		10
		...
		Partner NGO identifies educated youth in the target area and leverages them to communicate with the people.
		Educated youth also initiate education services ventures and charge fees from the families for their services.
		<br /><br />
		14
		Periodic Communication and Feedback
		Partner NGO staff and SS staff/volunteers periodically visit the target area and obtain feedback from the
		people about the Learning Rewards program.
		<br /><br />
		15
