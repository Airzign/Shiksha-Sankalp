...
ADMIN_OPTION;
    ...
    if ( $r !== false && mysql_num_rows($r) > 0 ) {
      while ( $a = mysql_fetch_assoc($r) ) {
        $heading = stripslashes($a['pic_desc']);
	...
	<p><a href="edit_impact.php?e=$id">Edit</a></p>
	<p><a href="edit_impact.php?e=$id&d=1" onclick="return confirmDelete();">Delete</a></p>
...
ENTRY_DISPLAY;
    ...
    <h4>No impact stories to display</h4>
    <p>
