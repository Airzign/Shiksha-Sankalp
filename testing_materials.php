...
<div id="content">
  <div id="main_content">
    ...
    <div class="innertitle">Testing Materials</div>
    <table class="info_table" cellspacing="5px">
      <tr>
        <th style="width:100px;">Upload Date</th>
        <th style="width:440px;">Testing Material</th>
        <th style="width:100px;">File Link</th>
      </tr>
      <?php
	 $results = mysql_query("select * from testing_materials order by date desc");
